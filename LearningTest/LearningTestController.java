...
public class LearningTestController {
	...
	public void setQue() throws IOException, SQLException{
		...
		if(queno == 15){
			...
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/LearningTest/Result.fxml"));
			...
			if(points >= 9){
				...
				rc.btn.setText("Print License");
				rc.name.setText(name.getText());
				preparedStatement = conection.prepareStatement("update Learning set Pass = 1 where name = ?");
